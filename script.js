document.addEventListener("DOMContentLoaded", function () { // Wait for DOM to be fully loaded before running the script
    ...
    const exportButton = document.getElementById("export-button"); // Button to export auction data (may be unused)
    const addAuctionButton = document.getElementById("add-auction-button"); // Button to add a new auction (may be unused)
    ...
    let notifiedKeywords = new Set(); // Track which keywords have been notified for this session
    ...
    // This function is assumed to exist in the global scope (from index.html)
